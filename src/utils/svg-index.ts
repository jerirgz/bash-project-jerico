...
// WORKS
export const CONTACT_SVG = `<div class="svg-logos"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0,0,256,200">
<g fill="#ffffff" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><g transform="scale(4,4)"><g id="Layer_1"><path d="M44,26v4h8v-4zM44,34v4h8v-4zM16,38v10h4v-6h16v6h4v-10zM44,42v4h8v-4z"></path><path d="M60,56v-40h-37l1,4h32v32h-44v-40h10l-1,-4h-17v48z"></path><circle cx="28" cy="29" r="6"></circle></g></g></g>
</svg></div>`;

export const LINKEDIN_SVG = `<div class="svg-logos"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0,0,256,200">
...
export const GITHUB_SVG = `<div class="svg-logos"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0,0,256,200">
